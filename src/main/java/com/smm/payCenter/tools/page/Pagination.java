package com.smm.payCenter.tools.page;
...
public class Pagination {
		...
		try {
			...
			case 0:
				...
				if (prevPage < 1) {
					...
					str += "<span title='到第一页'><a href='" + this.toPage(1) + "'>&#171;</a></span>";

					str += "<span title='上一页'><a href='" + this.toPage(prevPage) + ");'>&#139;</a></span>";
				}
				for (long i = 1; i <= this.totalPage; i++) {
					if (i > 0) {
						if (i == this.page) {
							...
							str += "<span title='第 " + i + "页'><a href='" + this.toPage(i) + "'>[" + i + "]</a></span>";
						}
					}
				}
				if (nextPage > this.totalPage) {
					...
					str += "<span title='下一页'><a href='" + this.toPage(nextPage) + "'>&#155;</a></span>";

					str += "<span title='到最后一页'><a href='" + this.toPage(this.totalPage) + " ');'>&#187;</a></span>";
				}
				str += "</span><br/>";
			...
			case 1: // 模式1 (10页缩略,首页,前页,后页,尾页)
				...
				if (startPage > pageSize) {
					str += "<span title='Prev " + pageSize + " Pages'><a href='" + this.toPage(startPage - 1) + "'>上一页</a></span>";
				}
				for (long i = startPage; i < (startPage + pageSize); i++) {
					...
					if (i == this.page) {
						...
						str += "<span title='Page " + i + "'><a href='" + this.toPage(i) + "'>[" + i + "]</a></span>";
					}
				}
				if (this.totalPage >= (startPage + pageSize)) {
					str += "<span title='Next " + pageSize + " Pages'><a href='" + this.toPage(startPage + pageSize) + "'>下一页</a></span>";
				}
				if (nextPage > this.totalPage) {
					str += "<span title='下页'>&#155;</span>";
					str += "<span title='最后一页'>&#187;</span>";
			...
			case 2: // 模式2 (前后缩略,页数,首页,前页,后页,尾页)
				...
				if (this.page != 1) {
					str += "<span title='到第一页'><a href='" + this.toPage(1) + "'>[1]</a></span>";
				}
				...
				if (this.page != this.totalPage) {
					str += "<span title= '第 " + this.totalPage + "'><a href='" + this.toPage(this.totalPage) + "');'>[" + this.totalPage + "]</a></span>";
				}
			...
			case 4: // 模式3 (箭头样式,首页,前页,后页,尾页) (only IE)
				...
				if (prevPage < 1) {
					...
					str += "<span title='到第一页'><a href='" + this.toPage(1) + "'><strong><<</strong></a></span>";
					str += "<span title='上一页'><a href='" + this.toPage(prevPage) + "'><font color='red'> < </font></a></span>";
				}
				if (nextPage > this.totalPage) {
					...
					str += "<span title='下一页'><a href='" + this.toPage(nextPage) + "'><font color='red'> > </font></a></span>";

					str += "<span title='最后一页'><a href='" + this.toPage(this.totalPage) + "'><strong>>></strong></a></span>";
				}
				str += "</span><br/>";
				break;
			...
			case 5: // 模式4 (下拉框)
				if (this.totalPage < 1) {
					...
					for (long i = 1; i <= this.totalPage; i++) {
						...
						str += "<option value='" + this.toPage(i) + "'" + chkSelect + ">到:  " + i + " /  " + this.totalPage + "页</option>";
					}
				}
				str += "</select>";
				break;
			case 6: // 模式5 (输入框)
				...
				if (this.totalPage < 1) {
					...
					str += "<input type='text' id='pageInput" + this.showTimes + " + ' value='" + this.page + "' class='itext' title='Input page'  onfocus='this.select()'>";

					str += "<input type='text' value=' / " + this.totalPage + "' class='icount' readonly='readonly'>";

					str += "<input type='button' name='go' value='GO' class='ibutton' onclick='location='" + this.toPage(1) + "'></input>";
				}
				str += "</span>";
				break;
			case 7:
				...
				if (this.totalPage <= 1) {
					...
					if (this.page == 1) {
						...
						str += "<span>&nbsp;&nbsp;|&nbsp;&nbsp;" + this.page + "&nbsp;&nbsp;<a href='" + this.toPage(this.page + 1) + "'>" + (this.page + 1) + "</a>&nbsp;&nbsp;|&nbsp;&nbsp;</span>";

						str += "<span title=\"下一页\"><a href=\'" + this.toPage(nextPage) + "'>\u4e0b\u4e00\u9875</a></span>";
						String chkSelect;
						...
						if ((this.page > 1) && (this.page < this.totalPage)) {
							str += "<span title=\"上一页\"><a href='" + this.toPage(prevPage) + "'>\u4e0a\u4e00\u9875</a></span>";
							str += "<span>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='" + this.toPage(this.page - 1) + "'>" + (this.page - 1) + "</a>&nbsp;&nbsp;" + this.page + "&nbsp;&nbsp;<a href='"
									+ this.toPage(this.page + 1) + "'>" + (this.page + 1) + "</a>&nbsp;&nbsp;|&nbsp;&nbsp;</span>";
							...
							if (this.page == this.totalPage) {
								...
								str += "<span>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='" + this.toPage(this.page - 1) + "'>" + (this.page - 1) + "</a>&nbsp;&nbsp;" + this.page
										+ "&nbsp;&nbsp;|&nbsp;&nbsp;</span>";
			...
			case 8:
				if (startPage > pageSize) {
					str += " <span id='pages' title='Prev " + pageSize + " Pages'><a href='" + this.toPage(startPage - 1) + "'>上一页</a></span>";
				}
				for (long i = startPage; i < (startPage + pageSize); i++) {
					if (i > this.totalPage) {
						break;
					...
					if (i == this.page) {
						str += "<span id='currentPage' title='Page " + i + "'>" + i + "</span>";
					} else {
						str += "<span id='test' title='Page " + i + "'><a href='" + this.toPage(i) + "'>" + i + "</a></span>";

					}

				}
				if (this.totalPage >= (startPage + pageSize)) {
					str += "<span id='pages' title='Next " + pageSize + " Pages'><a href='" + this.toPage(startPage + pageSize) + "')'>下一页</a></span>";
					str += "</span><br/>";
			...
			case 9: // 模式2 (前后缩略,页数,首页,前页,后页,尾页)
				...
				if (prevPage < 1) {
					...
					str += "<span id=\"pages\"  title='到第一页'><a href='" + this.toPage(1) + "'>首页</a></span>";

					str += "<span id=\"pages\" title='上一页'><a href='" + this.toPage(prevPage) + " ');'>上一页</a></span>";
				}
				if (this.page != 1) {
					str += "<span id=\"test\" title='到第一页'><a href='" + this.toPage(1) + "'>1</a></span>";
				}
				...
				for (long i = this.page - 2; i <= endPage1; i++) {
					if (i > 0) {
						if (i == this.page) {
							...
							str += "<span id=\"currentPage\" title='第 " + i + "页'>" + i + "</span>";
						} else {
							if ((i != 1) && (i != this.totalPage)) {
								str += "<span id=\"test\" title='第 " + i + "页'><a href='" + this.toPage(i) + "'>" + i + "</a></span>";
							}
						}
					}
				}
				...
				if (this.page != this.totalPage) {
					str += "<span id=\"test\" title= '第 " + this.totalPage + "页'><a href='" + this.toPage(this.totalPage) + "');'>" + this.totalPage + "</a></span>";
				}
				...
				if (nextPage > this.totalPage) {
					...
					str += "<span id=\"pages\"  title='下一页'><a href='" + this.toPage(nextPage) + "'>下一页</a></span>";

					str += "<span id=\"toLast\" title='最后一页'><a href='" + this.toPage(this.totalPage) + " ');'>最后一页</a></span>";
				}
				str += "</span><br/>";
				break;
			case 10:
				str += "<div id=\"cp_page\">";
				str += "<div class=\"Pages\" url=\""+this.action.replace("&page=", "")+"\">";
				str += "<span>总共<span class=\"PageCount\">" + this.totalResultSize + "</span>条记录</span>";
				long endPage2 = 0;
				if (prevPage < 1) {
					str += "<a href=\"#\" title=\"上一页\" class=\"PrevPage\" >上一页</a>";
				} else {
					str += "<a href=\"" + this.toPage(prevPage) + "\" page=\""+prevPage+"\" title=\"上一页\" class=\"PrevPage\" >上一页</a>";
				}
				if (this.page != 1) {
					str += "<a href=\"" + this.toPage(1) + "\" page=\""+1+"\" title=\"到第一页\" class=\"PageLink\" >1</a>";
				}
				...
				for (long i = this.page - 5; i <= endPage2; i++) {
					if (i > 0) {
						if (i == this.page) {
							...
							if ((i != 1) && (i != this.totalPage)) {
								str += "<a href=\"" + this.toPage(i) + "\" page=\""+i+"\" class=\"PageLink\" title='第 " + i + "页'>" + i + "</a>";
							}
						}
					}
				}
				...
				if (this.page != this.totalPage) {
					str += "<a  href=\"" + this.toPage(this.totalPage) + "\" page=\""+totalPage+"\" class=\"PageLink\" title= '第 " + this.totalPage + "页'>" + this.totalPage + "</a>";
				}
				...
				if (nextPage > this.totalPage) {
					...
					str += "<a href=\"" + this.toPage(nextPage) + " \" page=\""+nextPage+"\" title=\"下一页\" class=\"NextPage PageLink PageLink_page\" >下一页</a>";
				}
				str += "</span><br/>";
				str += "</div>";
				str += "</div>";
			...
			case 11:
				...
				if (prevPage < 1) {
					...
					str += "<a href=\"" + this.toPage(prevPage) + "\" title=\"上一页\" class=\"PrevPage\" >上一页</a>";
				}
				if (this.page != 1) {
					str += "<a href=\"" + this.toPage(1) + "\" title=\"到第一页\" class=\"PageLink\" >1</a>";
				}
				...
				for (long i = this.page - 5; i <= endPage11; i++) {
					if (i > 0) {
						if (i == this.page) {
							...
							if ((i != 1) && (i != this.totalPage)) {
								str += "<a href=\"" + this.toPage(i) + "\" class=\"PageLink\" title='第 " + i + "页'>" + i + "</a>";
							}
						}
					}
				}
				...
				if (this.page != this.totalPage) {
					str += "<a  href='" + this.toPage(this.totalPage) + "' class=\"PageLink\" title= '第 " + this.totalPage + "页'>" + this.totalPage + "</a>";
				}
				...
				if (nextPage > this.totalPage) {
					...
					str += "<a class=\"PageLink NextPage PageLink_page\" href='" + this.toPage(nextPage) + " ' title=\"下一页\" >下一页</a>";
				}
				str += "<span> 显示<select name=\"changePageSize\" style=\"width:100px;\" onchange='location=this.options[this.selectedIndex].value'>";
				String chkSelect11 = "";
				for (int size : pageSizeList) {
					...
					str += "<option value='" + this.toPageWithSize(size) + "'" + chkSelect11 + ">" + size + "</option>";
				}
	...
	private String createFormPagination() {
		...
		for (long i = this.page - 5; i <= endPage2; i++) {
			if (i > 0) {
				if (i == this.page) {
					...
					if ((i != 1) && (i != this.totalPage)) {
						sb.append("<a href='#' class='PageLink " + pageAName + "'  page='" + i + "' title='第" + i + "页'>" + i + "</a>");
					}
				}
			}
		}
		...
		if (this.page != this.totalPage) {
			sb.append("<a  href='#' page='" + totalPage + "' class=\"PageLink " + pageAName + "\" title= '第" + this.totalPage + "页'>" + this.totalPage + "</a>");
		}
