...
//	@Value("#{ch['sendSMS.URL']}")
	...
	public  String sendsmm(String time,String message,String mobiles) {
		...
		try {
			...
			String url = sendSMS;
			String paras = "command=SMS20_REQUEST&time="+ m.replaceAll("").trim() + "000&message="+message+"&mobiles="+mobiles;
			// 创建url
	...
	public static void main(String[] args) {
		Texting text = new Texting();
		String message = text.sendsmm("2015-12-22 10:00:00","短信","13539407642");
