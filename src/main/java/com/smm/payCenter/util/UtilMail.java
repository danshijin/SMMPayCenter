...
public class UtilMail {
    ...
    public void doSendHtmlEmail(String subject, String sendHtml, String receiveUser) {
        try {
        	Thread.sleep(10000);//停10秒发送

            // 发件人
            //InternetAddress from = new InternetAddress(sender_username);
            // 下面这个是设置发送人的Nick name
            InternetAddress from = new InternetAddress("no-replay@smm.cn");
            from.setPersonal(MimeUtility.encodeText("上海有色网"),"utf-8");
    ...
    public static void main(String[] args) {
        ...
        se.doSendHtmlEmail("标题", "<a href='http://mail.qq.com'>33333</a>", "hece@smm.com.cn");
    }
