...
var CommonUtils = {
	...
	editDialog: function(url, width, height){
		...
		var html = '<div class="modal fade modal-scroll in editModal" id="myModal" role="basic" aria-hidden="false" data-backdrop="static" data-keyboard="false">'
				+ '<div class="page-loading page-loading-boxed">'
				+ '<img src="../Public/assets/global/img/loading-spinner-grey.gif" alt="" class="loading">'
				+ '<span>&nbsp;&nbsp;正在加载.....</span>'
				+ '</div>'
		...
		var tmpl = ['<div id="basic" class="modal fade" tabindex="-1" role="basic" data-backdrop="static" data-keyboard="false">',
		            '<div class="modal-dialog">',
			            '<div class="modal-content">',
							...
							'</div>',
							'<div class="modal-footer">',
								'<button type="button" data-dismiss="modal" class="btn red  fa fa-check">确定</button>',
							'</div>',
						'</div>',
					'</div>',
				'</div>'
